  ...
  {showCard && (
    <Card sx={{ mt: 4, mb: 4, padding: 0, backgroundColor: "#f4f4f4", borderRadius: 2 }}>
      ...
      <Typography variant="body1">
        ...
        This platform serves only as a means to connect individuals who have lost or found items. We are <strong>not responsible</strong> for any security risks, damages, or incidents that may occur once users communicate or meet in person.  

        It is the responsibility of <strong>both parties</strong> to ensure their own safety. We strongly recommend:  
        <ul style={{ marginTop: '0.5rem', marginBottom: '0.5rem', paddingLeft: '1.5rem' }}>
          <li>Verifying the identity of the other party before sharing personal information.</li>
          <li>Meeting in a <strong>public, well-lit area</strong> if an in-person exchange is necessary.</li>
          <li>Bringing a friend or notifying someone about the meeting.</li>
          <li>Avoiding sharing sensitive information (e.g., home address, financial details).</li>
        </ul>

        By using this service, you acknowledge and accept these risks. <strong>Stay vigilant and prioritise your safety.</strong>
      </Typography>
        <Box sx={{ mt: 1 }}>
